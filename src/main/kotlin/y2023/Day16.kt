...
data class BeamMap(val map: List<String>, val startingBeam: Beam) {
    ...
    fun showPropagatedBeam() {
        if (beamsWithDirections.isNotEmpty()) {
            ...
            colorPrintln("y2023.Beam was not propagated yet !", EscapeSequence.Color.RedBold)
        }
    }
...
// test if implementation meets criteria from the description, like:
    ...
    compare(part1(testInput, withProgress = true), 46)
    compare(part2(testInput, withProgress = true), 51)

// partial real input for visualisation purposes
    val visualInput = readInput(2023, "Day16_visual")
