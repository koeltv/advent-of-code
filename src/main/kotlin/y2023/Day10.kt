...
fun main() {
    ...
    val testInput = readInput(2023, "Day10_test")
    check(part1(testInput) == 8)

    check(part2(readInput(2023, "Day10_test21")) == 4)
    check(part2(readInput(2023, "Day10_test22")) == 4)
    check(part2(readInput(2023, "Day10_test23")) == 8)
    check(part2(readInput(2023, "Day10_test24")) == 10)
